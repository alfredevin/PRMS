...
(function (global, factory) {
  ...
  function report (_ref) {
    ...
    if (noConflictsCount > 0) {
      console.info("%cNo conflict".concat(noConflictsCount > 1 ? 's' : '', " found with ").concat(noConflictsCount == 1 ? 'this' : 'these', ":"), 'color: #03045e; font-size: large');
      var _data = {};
  ...
  function conflictDetection() {
    ...
    if (testCount === 0) {
      console.info('%cAll Good!', 'color: #03045e; font-size: large');
